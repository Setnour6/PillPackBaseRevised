...
pk_pills.convars.admin_globalspeedamount = CreateConVar("pk_pill_admin_globalspeedamount", 0, FCVAR_REPLICATED, "Amount of run speed that all pills will have if pk_pill_admin_globalspeed is enabled.", 1, 2000)
...
pk_pills.convars.admin_globalcrouchwalkspeedamount = CreateConVar("pk_pill_admin_globalcrouchwalkspeedamount", 0, FCVAR_REPLICATED, "Amount of crouch walk speed from all pills will have if pk_pill_admin_globalcrouchwalkspeed is enabled.", 0.1, 1)
...
pk_pills.convars.admin_globaljumppoweramount = CreateConVar("pk_pill_admin_globaljumppoweramount", 0, FCVAR_REPLICATED, "Amount of jump power that all pills will have if pk_pill_admin_globaljumppower is enabled.", 1, 100)
...
pk_pills.convars.admin_fastcloakamount = CreateConVar("pk_pill_admin_fastcloakamount", 0, FCVAR_REPLICATED, "How fast cloaking is for some pills if pk_pill_admin_fastcloak is enabled.", 1, 255)
